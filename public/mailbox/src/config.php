...
$config['imap']['url'] = '{imap.one.com:993/imap/ssl}INBOX';
$config['imap']['username'] = "omnea@uruk.uk";
$config['imap']['password'] = "Gyhu1212";
...
$config['domains'] = array('one.com', 'example.com');
