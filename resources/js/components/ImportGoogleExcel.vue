        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Import Google Excel File</h4>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async downloadFile() {
            this.$Progress.start()
            await axios.post('/api/download-google-import-sample-file').then(response => {
                console.log(response.data);
                this.sampleFileLink = response.data;

                const downloadLink = response.data;
                const fileName = 'omnya-google-import-sample-file.xlsx';
        ...
        async importData() {
            ...
            await axios
                .post("/api/googleUser/import-excel", formData, {
                    headers: {
