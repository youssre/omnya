            ...
            <div class="col-12">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-box d-sm-flex">
                        ...
                        <router-link to="adduser"><b-button class="btn btn-primary">Add User</b-button></router-link>
                    </div>
                        ...
                        <form @submit.prevent="submitForm" @keydown="form.onKeydown($event)">
                            <div class="row">
                                ...
                                <!-- <div class="col-sm-12 col-md-4 col-lg-4 mb-4">
                                    <label class="form-label" for="page_url">Page URL</label>
                                    <input id="page_url" name="page_url" v-model="form.page_url" type="text"
                                        class="form-control">
                                </div> -->
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            <div v-if="allReadySelectedRows.length" slot="selected-row-actions"
                                ...
                                <button class="btn btn-danger btn-sm" @click="bulkDeletePeople">Bulk Delete</button>
                    ...
                    <vue-good-table mode="remote" :line-numbers="true" @on-page-change="onPageChange"
                        ...
                        <template slot="table-row" slot-scope="props">
                            ...
                            <td v-if="props.column.field === 'recovery_email'"
                                ...
                                <label>{{ props.row.recovery_email }}
                                    <span v-if="props.row.is_recovery_enable == 1" style="color: green;">
                                        <i class="bi bi-bookmark-check text-primary"></i></span></label>
                            </td>
                            ...
                            <td v-if="props.column.field === 'action'"
                                style="border: 0px;padding: 0;width: 80px;margin: 0;">
                                <router-link :to="{ name: 'updateuser', params: { profile_id: props.row.profile_id } }"
                                    class="text-dark">
...
export default {
    ...
    methods: {
        ...
        async submitForm() {
            await this.form.post('/api/get-people', {
                params: {
                    page: 1,
        ...
        async fetchData() {
            try {
                const response = await this.form.post('/api/get-people', {
                    params: {
        ...
        async bulkDeletePeople() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post("/api/people/bulk-delete", this.selectedRows)
                        .then(response => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Deleted!',
            ...
            // try {
            //     const response = await axios.post('/api/get-people', {
            //         params: {
            //             page: this.paginationOption.setCurrentPage,
            //             perPage: this.paginationOption.perPage,
            //             search: this.searchTerm,
        ...
        async exportData() {
            try {
                ...
                const response = await axios.post("/api/people/export", this.selectedRows);
        ...
        async exportQR() {
            try {
                ...
                const response = await axios.post("/api/people/exportQr", this.selectedRows);
        ...
        async downloadQRCode(data) {
            ...
            try {
                ...
                // const response = await axios.post("/api/download/qr-code", data);
                // console.log(data);
                // const downloadLink = response.data.return_array.downloadLink;
                // const fileName = response.data.return_array.fileName;
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        // Send delete request
                        await axios.post('/api/delete-people', { id: id });
